<div class="my-6 w-full flex flex-col items-center" >
                ...
                <h2 class="text-2xl uppercase text-center my-4 font-semibold p-2 rounded bg-blue-900 text-basic_white_color w-full  md:w-3/4 lg:w-1/2" >Programme de diffusion</h2>
                ...
                <section class="flex flex-col w-full items-center" >
                    ...
                    @php
                        ...
                        $periodesCount= $adr->periodes->count()??1;


                        $data=$periodesCount>=1?json_encode($adr->periodes()->get(['periode_date','id','periode_hour'])):json_encode([]);
