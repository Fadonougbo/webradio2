        ...
        <div class="w-full flex flex-col items-center" >
            ...
            <section class="w-full flex flex-col items-center lg:w-[75%] xl:w-[65%] " >
                ...
                <div class="mt-20 w-full tm:mt-28 " >
                    ...
                    <p class="my-4 flex text-sm text-blue-900 items-center" >
                        <span class="flex items-center capitalize font-medium " >
                            <i data-lucide="circle-user-round" class="mx-1 size-6" ></i>
            
                            {{$author}}
                        </span>
                        <span class="text-lg mx-1" >-</span>
                        <span class="flex items-center capitalize  " >
                            <i data-lucide="calendar-days" class="mx-1 size-6"></i>
                            {{$date}}
                        </span>

                        @can('show_administration')
                        <a class="text-white bg-green-600 p-2 rounded mx-2" href="{{route('dashboard.blog.update.article',['article'=>$article->id])}}">
                            Modifier
                        </a>
                    @endcan
                    </p>
                ...
                <div class="my-4" >
                    <!--  -->
                    <p class="text-center my-1" >Partarger sur</p>
