<div class="my-6 w-full flex  flex-col items-center" >
    <h2 class="text-xl uppercase rounded text-center p-2  my-4 font-semibold inline-block bg-green-900 text-basic_white_color w-full md:text-2xl  md:w-3/4 lg:w-1/2" >Informations sur le demandeur</h2> 
    ...
    <section class="flex flex-col w-full items-center" >
        ...
        <div class="flex flex-col my-3 w-full md:w-3/4 lg:w-1/2" >
            ...
            <input type="tel" class="rounded w-full" value="{{old('communique_tel',$communique?->communique_tel)}}" placeholder="ex: 91810043" name="communique_tel" id="communique_tel"  required>
