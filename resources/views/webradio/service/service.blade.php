...
<!-- 
    ...
    <main class="p-4 my-24 min-h-screen" >
        ...
        <h2 class="my-6 text-4xl font-semibold underline decoration-solid underline-offset-2 md:text-center leading-relaxed " > Voici une liste des divers services offerts par la <abbr title="Radio Trait d'Union">RTU</abbr>  pour répondre aux besoins et aux intérêts de son auditoire.</h2>
