<x-app-layout>
    ...
    <div class="p-4" >
        <form action="{{route('dashboard.blog.store.article')}}" method="POST" >
                ...
                <section class="flex flex-col w-full items-center" >
                        <div class="flex flex-col my-3 w-[90%] md:w-3/4 lg:w-1/2 " >
                                ...
                                <input type="text" id="article_title" value="{{old('article_title')}}" class=" w-full ring-2 rounded-lg" name="article_title" >
                        ...
                        <div class="flex flex-col my-3 w-[90%] md:w-3/4 lg:w-1/2 " >
                                ...
                                <input type="text" id="article_slug" value="{{old('article_slug')}}" class=" w-full ring-2 rounded-lg" name="article_slug" >
                        ...
                        <div class="flex flex-col my-3 w-[90%] md:w-3/4 lg:w-1/2 " >
                                ...
                                <input type="checkbox" class="checkbox checkbox-success  accent-white checkbox-lg border-2" id="isOnline" value="{{old('isOnline')}}" name="isOnline" checked/>
